...
CORIM_DEPS += $(CORIM_DIR)/conditional-endorsement-series-triple-record.cddl
CORIM_DEPS += $(CORIM_DIR)/conditional-endorsement-triple-record.cddl
CORIM_DEPS += $(CORIM_DIR)/conditional-series-record.cddl
...
CORIM_DEPS += $(CORIM_DIR)/digest.cddl
...
CORIM_DEPS += $(CORIM_DIR)/stateful-environment-record.cddl
